...
extension TopicEntityByIndex on IsarCollection<TopicEntity> {
  Future<TopicEntity?> getByName(String name) {
    return getByIndex(r'name', [name]);
  }

  TopicEntity? getByNameSync(String name) {
  ...
  Future<List<TopicEntity?>> getAllByName(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
    return getAllByIndex(r'name', values);
  }

  List<TopicEntity?> getAllByNameSync(List<String> nameValues) {
    final values = nameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByName(TopicEntity object) {
    return putByIndex(r'name', object);
  }

  Id putByNameSync(TopicEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'name', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByName(List<TopicEntity> objects) {
    return putAllByIndex(r'name', objects);
  }

  List<Id> putAllByNameSync(List<TopicEntity> objects,
      {bool saveLinks = true}) {
...
extension TopicEntityQueryWhere
  ...
  QueryBuilder<TopicEntity, TopicEntity, QAfterWhereClause> nameEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TopicEntity, TopicEntity, QAfterWhereClause> nameNotEqualTo(
      String name) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension TopicEntityQueryProperty
  ...
  QueryBuilder<TopicEntity, DateTime, QQueryOperations> createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
